...
> Run these designs in [Potato](https://www.potatoannotator.com). See the [Potato documentation](https://www.potatoannotator.com/docs) to configure temporal and frame-level video annotation.

## Subcategories

### [Action Recognition](https://github.com/davidjurgens/potato-showcase/tree/main/video/action-recognition)

| Design | Description | Reference |
|--------|-------------|-----------|
| [activitynet-temporal-localization](https://github.com/davidjurgens/potato-showcase/tree/main/video/action-recognition/activitynet-temporal-localization) | ActivityNet is a large-scale video benchmark for human activity understanding, with untrimmed YouTube… | Caba Heilbron et al., CVPR 2015 |
| [ava-atomic-actions](https://github.com/davidjurgens/potato-showcase/tree/main/video/action-recognition/ava-atomic-actions) | AVA spatio-temporally localizes 80 atomic actions on people in movie clips, labeled at 1 Hz keyframes | Gu et al., CVPR 2018 |
| [breakfast-actions](https://github.com/davidjurgens/potato-showcase/tree/main/video/action-recognition/breakfast-actions) | Fine-grained temporal action segmentation of breakfast preparation activities | Kuehne et al., CVPR 2014 |
| [charades-activity-segmentation](https://github.com/davidjurgens/potato-showcase/tree/main/video/action-recognition/charades-activity-segmentation) | Multi-label temporal activity segmentation in indoor home videos | Sigurdsson et al., ECCV 2016 |
| [epic-kitchens-egocentric](https://github.com/davidjurgens/potato-showcase/tree/main/video/action-recognition/epic-kitchens-egocentric) | Annotate fine-grained actions in egocentric kitchen videos with verb-noun pairs | Damen et al., ECCV 2018 |
| [finediving-procedure-aqa](https://github.com/davidjurgens/potato-showcase/tree/main/video/action-recognition/finediving-procedure-aqa) | Fine-grained diving action quality assessment | Xu et al., CVPR 2022 |
| [finegym-action-segments](https://github.com/davidjurgens/potato-showcase/tree/main/video/action-recognition/finegym-action-segments) | FineGym is a hierarchical video dataset (CVPR 2020) for fine-grained gymnastics action recognition:… | Shao et al., CVPR 2020 |
| [fisv-figure-skating-scoring](https://github.com/davidjurgens/potato-showcase/tree/main/video/action-recognition/fisv-figure-skating-scoring) | Automatic figure skating scoring as video regression | Xu et al., IEEE TCSVT 2020 |
...
| Design | Description | Reference |
|--------|-------------|-----------|
| [ami-meeting-annotation](https://github.com/davidjurgens/potato-showcase/tree/main/video/ami-meeting-annotation) | Multi-tier ELAN-style annotation of multi-party meeting recordings | Carletta et al., MLMI 2005 |

### [Boundary Detection](https://github.com/davidjurgens/potato-showcase/tree/main/video/boundary-detection)

| Design | Description | Reference |
|--------|-------------|-----------|
| [moviescenes-detection](https://github.com/davidjurgens/potato-showcase/tree/main/video/boundary-detection/moviescenes-detection) | Detect and annotate scene boundaries in movies | Rao et al., CVPR 2020 |
...
| Design | Description | Reference |
|--------|-------------|-----------|
| [iemocap-dyadic-emotion](https://github.com/davidjurgens/potato-showcase/tree/main/video/iemocap-dyadic-emotion) | IEMOCAP is a 12-hour audiovisual corpus of two-actor emotional conversations with categorical and… | Busso et al., Language Resources and Evaluation 2008 |

### [Instructional](https://github.com/davidjurgens/potato-showcase/tree/main/video/instructional)
...
| Design | Description | Reference |
|--------|-------------|-----------|
| [saga-gesture-speech](https://github.com/davidjurgens/potato-showcase/tree/main/video/saga-gesture-speech) | Multi-tier ELAN-style annotation of co-speech gestures and their alignment with spoken language | Lücking et al., Journal on Multimodal User Interfaces 2013 |

### [Scene Understanding](https://github.com/davidjurgens/potato-showcase/tree/main/video/scene-understanding)
...
| Design | Description | Reference |
|--------|-------------|-----------|
| [lsmdc-keyframe-selection](https://github.com/davidjurgens/potato-showcase/tree/main/video/summarization/lsmdc-keyframe-selection) | Select representative keyframes from movie clips for video description tasks | Rohrbach et al., IJCV 2017 |
| [summe-summarization](https://github.com/davidjurgens/potato-showcase/tree/main/video/summarization/summe-summarization) | Create video summaries by selecting key segments that best represent the content | Gygli et al., ECCV 2014 |
| [tvsum-summarization](https://github.com/davidjurgens/potato-showcase/tree/main/video/summarization/tvsum-summarization) | Frame-level importance scoring for video summarization | Song et al., CVPR 2015 |
| [youtube-highlights](https://github.com/davidjurgens/potato-showcase/tree/main/video/summarization/youtube-highlights) | Detect highlight-worthy moments in domain-specific videos | Sun et al., ECCV 2014 |

### [Temporal Grounding](https://github.com/davidjurgens/potato-showcase/tree/main/video/temporal-grounding)

| Design | Description | Reference |
|--------|-------------|-----------|
| [activitynet-captions](https://github.com/davidjurgens/potato-showcase/tree/main/video/temporal-grounding/activitynet-captions) | ActivityNet Captions pairs 20k untrimmed videos with 100k temporally localized sentence descriptions for… | Krishna et al., ICCV 2017 |
| [charades-sta-grounding](https://github.com/davidjurgens/potato-showcase/tree/main/video/temporal-grounding/charades-sta-grounding) | Ground natural language descriptions to video segments | Gao et al., ICCV 2017 |
...
| Design | Description | Reference |
|--------|-------------|-----------|
| [vstar-video-dialogue](https://github.com/davidjurgens/potato-showcase/tree/main/video/vstar-video-dialogue) | Video-grounded dialogue annotation | Wang et al., ACL 2023 |
